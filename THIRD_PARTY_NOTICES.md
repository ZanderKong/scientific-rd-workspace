...
- LiteLLM Python SDK `1.99.0` — MIT. Phase 3 embeds the SDK only; the LiteLLM Gateway/Proxy is not used.
- Langfuse Python SDK `4.15.1` — MIT. Phase 3 uses it only as an optional, disabled-by-default trace projection.
