...
> **归档历史模板（legacy-runtime）**：以下 prompts 适用于旧 Phase/runtime，不得作为当前实现指令。当前 Agent 约定从 [`AGENTS.md`](../../../AGENTS.md)、[`web/CLAUDE.md`](../../../web/CLAUDE.md) 和 [`docs/handoff/CURRENT_STATE.md`](../../handoff/CURRENT_STATE.md) 开始。
