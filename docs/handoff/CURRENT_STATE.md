...
- 发布以前，GitHub Actions 必须通过六个 blocking jobs：Backend / PostgreSQL 17、Migration / Legacy 0006 → v0.3、Frontend / Quality、MCP / Contract、Browser / First Run 和 Browser / Golden Scientific Workflow。
