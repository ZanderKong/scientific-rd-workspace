...
- Agent-facing contract and examples for desired-state updates, precursor Samples, Equipment usage schema additions, and usage values.
...
The canonical aggregate contract is documented in [SAMPLE_RECORDING_API_EXAMPLES.md](../agent/SAMPLE_RECORDING_API_EXAMPLES.md).
