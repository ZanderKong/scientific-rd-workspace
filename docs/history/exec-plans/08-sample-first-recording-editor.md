...
2. Read, in order:
   ...
   - `docs/history/handoff/V0_2_CORE_SEMANTIC_STABILIZATION_HANDOFF.md`
   - `ARCHITECTURE.md`
   - `docs/current/DATA_MODEL.md`
   - `docs/current/UI_SPEC.md`
   - this Plan 08
...
```text
docs/current/agent/SAMPLE_RECORDING.md
docs/current/agent/SAMPLE_RECORDING_API_EXAMPLES.md
```
...
```text
docs/history/handoff/SAMPLE_RECORDING_WORKFLOW_HANDOFF.md
```
