...
> **Historical handoff**: This records the v0.2 cutover at its original commit and verification boundary. It is not a replacement for the current state; see [`docs/handoff/CURRENT_STATE.md`](../../handoff/CURRENT_STATE.md).
